      ...
      <div className="card w-full max-w-md bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold text-primary">歡迎登入</h1>
            <p className="text-base-content/70 mt-2">請填寫您的登入資訊</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">帳號</span>
              </label>
              <input
                type="text"
                name="account"
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">邀請碼</span>
              </label>
              <input
                type="text"
                name="inviteCode"
